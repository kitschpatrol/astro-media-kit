...
/**
 * Probes an image file on disk and returns an ImageMetadata object. Useful as a
 * fallback when a Vite plugin returns a string path instead of ImageMetadata
